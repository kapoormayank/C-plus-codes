...
int CountNode(Node* root) {
    ...
    // recursive function
    int leftheight=CountNode(root->left); // Left Subtree
    int rightheight=CountNode(root->right); // Right Subtree
...
int main() {
    ...
    print(root);
    cout<<"\nCount number of Binary Search Tree(BST) Nodes: "<<CountNode(root)<<endl;
    return 0;
}
