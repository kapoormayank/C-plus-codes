// Sum of all leafs nodes Algorithm Implementation In C++
#include<iostream>
using namespace std;
...
int main() {
    ...
    print(root);
    cout<<"\nSum of all leafs nodes from Binary Search Tree(BST): "<<sumofLeafsNodes(root)<<endl;
    return 0;
}
